...
export function SocialsContainer() {
  return (
    <div className='w-full flex flex-row justify-center items-center gap-x-8'>
      ...
      <span className='absolute -top-4 w-56 left-14 end-0 scale-0 z-10 transition-all rounded bg-cyan-900 p-2 text-slate group-hover:scale-100 whitespace-nowrap'>
