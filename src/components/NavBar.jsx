...
const NavBar = ({ openModal, setOpenModal }) => {
  ...
  return (
    <Disclosure as='nav' className='p-1 bg-navy'>
      {({ open }) => (
        <>
          <div className='w-full absolute mx-auto py-2 px-4 md:px-6 lg:px-8 justify-between'>
                    ...
                    {navigation.map((item, index) => (
                      <a
                        ...
                        className={classNames(
                          ...
                          'code flex md:justify-center rounded-md px-3 items-center py-2 text-sm text-xs'
                        )}
              ...
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  className={classNames(
                    item.current
                      ? 'text-white'
                      : 'md:flex md:items-center md:justify-center text-gray-300 hover:text-green',
                    'md:flex md:flex-column md:justify-center code block rounded-md px-3 py-2 text-base font-medium'
                  )}
                  aria-current={item.current ? 'page' : undefined}
                >
                  {item.name}
