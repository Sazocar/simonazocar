    ...
    >
      ...
      <div className="mx-auto flex z-10 lg:flex-row lg:gap-x-20 flex-col justify-between items-center gap-y-10">
        ...
        <div className="group relative [&>div]:hover:-translate-x-2 [&>div]:hover:-translate-y-2 [&>div]:ease-in-out [&>div]:duration-300 ">
          <Image
            className="w-full max-w-[420px] z-10 drop-shadow-2xl rounded"
            width={420}
            height={420}
            priority
          ...
          <div className="absolute top-5 left-5 w-full max-w-[430px] -z-10 h-full sm:top-5 sm:left-5 sm:h-full border-green border-4 rounded "></div>
        </div>
      </div>
    </section>
  );
